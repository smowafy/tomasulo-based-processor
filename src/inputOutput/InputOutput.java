...
//		}
		...
		System.out.println("	 Enter program (in the form 'op dest src trg' without quotations, instruction in uppercase,  empty line at the end): ");
		...
		parser Parser = new parser(program, startingAddress);
	}
